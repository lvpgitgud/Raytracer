...
public:
	...
	bool hit(const ray& r, interval ray_t, hit_record& rec) const override {
		...
		//Determine if the hit poiint lies within the planar shapre using its plane coordinates
		...
		//Ray hits the 2D shapre; set the rest of the hit record and return true
		rec.t = t;
		rec.p = intersection;
		rec.mat = mat;
	...
	virtual bool is_interior(double a, double b, hit_record& rec) const {
		...
		//otherwise set the hit record UV coorinates and return true.
