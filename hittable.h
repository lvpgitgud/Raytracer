...
public:
	...
	bool hit(const ray& r, interval ray_t, hit_record& rec) const override {
		//Move the ray backwards by the off set
		ray offset_r(r.origin() - offset, r.direction(), r.time());

		//Determin wheter an intersection exists along the offset ray ( and if so, where)
...
public:
	...
	bool hit(const ray& r, interval ray_t, hit_record& rec) const override {
		...
		//Dtermin whether an intersection exists in object space (and if so, where).
